...
// API Youtube (Channel)
$result = get_CURL('https://www.googleapis.com/youtube/v3/channels?key=AIzaSyCzP9Ghr-9Z1lthkmTf7cBXUlamKYr97oc&part=snippet,statistics&id=UCkXmLjEr95LVtGuIm3l2dPg');
...
$result = get_CURL('https://www.googleapis.com/youtube/v3/search?key=AIzaSyCzP9Ghr-9Z1lthkmTf7cBXUlamKYr97oc&part=snippet&channelId=UCkXmLjEr95LVtGuIm3l2dPg&maxResults=1&order=date');
                ...
                <div class="col-md-5">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <h5><?= $channelName ?></h5>
                            <p><?= $subscriber ?></p>
                            <div class="g-ytsubscribe" data-channelid="UCkXmLjEr95LVtGuIm3l2dPg" data-layout="default"
                        ...
                        <div class="col">
                            <div class="embed-responsive embed-responsive-16by9">
                                <iframe class="embed-responsive-item"
                                    src="https://www.youtube.com/embed/<?= $latestVideo ?>" allowfullscreen>
                                </iframe>
                            </div>
                        </div>
                    </div>
